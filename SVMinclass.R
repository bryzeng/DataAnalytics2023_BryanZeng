...
# Petal.Width using the color separation respect to Species
...
# here the axes are Petal.Width Vs
# Petal.Length
...
table3
Model3_AccR = sum(diag(table3))/sum(table3)
Model3_AccR
Model3_MissClR = 1 - Model3_AccR
Model3_MissClR
